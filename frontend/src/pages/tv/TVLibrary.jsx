                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="border-b border-[#2a2a35] bg-[#0d0d14]">
                                        ...
                                        <th className="px-4 md:px-6 py-4 font-mono text-[10px] text-[#7a7a90] uppercase tracking-widest hidden sm:table-cell">Genre</th>
                                        <th className="px-4 md:px-6 py-4 font-mono text-[10px] text-[#7a7a90] uppercase tracking-widest hidden md:table-cell">Progress (S/E)</th>
    ...
    return (
        <tr className="border-b border-[#2a2a35] hover:bg-white/[0.02] transition-colors group">
                ...
                <div className="flex flex-col gap-0.5">
                    ...
                    <div className="flex flex-wrap items-center gap-x-1.5 gap-y-1">
                        ...
                        <div className="md:hidden flex flex-col gap-0.5">
                            ...
                            <span className="text-[#5c9fff] font-mono text-[7px] font-bold uppercase leading-none">
                                S{show.seasonsWatched || 0}/{show.totalSeasons || '?'}
                            </span>
                        </div>
                        <p className="text-[#4a4a5e] font-mono text-[8px] md:text-[10px] uppercase tracking-wider truncate max-w-[60px] md:max-w-none">{show.genre || 'TV'}</p>
                    </div>
                </div>
            </td>
            <td className="px-4 md:px-6 py-4 text-center">
                {show.rating > 0 ? (
                    <span className="text-[#c8ff57] font-black text-xl md:text-2xl leading-none" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>{show.rating}</span>
                ) : (
            ...
            <td className="px-4 md:px-6 py-4 hidden md:table-cell">
                <div className="flex flex-col gap-1 md:gap-2 min-w-[80px] md:min-w-[140px]">
                    {/* Seasons Progress */}
                    <div className="flex items-center gap-1 md:gap-2">
                        ...
                        <span className="text-[#5c9fff] font-mono text-[8px] md:text-[9px] whitespace-nowrap">
                            S{show.seasonsWatched || 0}/{show.totalSeasons || '?'}
                        </span>
                    </div>
                    {/* Episodes Progress */}
                    <div className="flex items-center gap-1 md:gap-2">
                        ...
                        <span className="text-[#7a7a90] font-mono text-[8px] md:text-[9px] whitespace-nowrap">
                            E{show.episodesWatched || 0}/{show.totalEpisodes || '?'}
                        </span>
                    </div>
                </div>
