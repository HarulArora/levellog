    ...
    const handleAddToList = async (listId, listName) => {
        try {
            await api.put(`/lists/custom/${listId}/game`, {
                externalId: id, gameTitle: anime.title,
                gameCover: anime.cover || anime.coverImage, genre: anime.genres?.[0], action: 'add'
            })
                    ...
                    <div className="bg-[#111118] border border-[#2a2a35] rounded-lg w-full max-w-sm overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
                        <div className="flex items-center justify-between p-5 border-b border-[#2a2a35]">
                            <div>
                                ...
                                <div className="font-mono text-[10px] text-[#7a7a90] mt-0.5 truncate max-w-[220px]">{anime.title}</div>
                            </div>
                        ...
                        <div className="p-5">
                            {user?.level < 2 ? (
                                ...
                                <div className="flex flex-col items-center gap-3 py-8 text-center">
                                    ...
                                    <div className="font-mono text-xs text-[#7a7a90]">No {type} collections yet.</div>
