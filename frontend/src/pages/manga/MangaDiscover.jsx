...
import { Search, Flame, Star, Trophy, BookOpen, ChevronRight } from 'lucide-react'
...
function MangaDiscover() {
    ...
    return (
        <div className="min-h-screen pb-20">
            <Helmet>
                <title>Discover {activeGenre ? activeGenre.label : 'Manga'} | QuestDuck</title>
            </Helmet>
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        <div className="max-w-xl">
                            <h1 className="font-black text-5xl md:text-6xl text-white uppercase mb-4" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
                                Discover <span className="text-[#c8ff57]">{activeGenre ? activeGenre.label : 'Manga'}</span>
                            </h1>
                            <p className="text-[#7a7a90] text-sm font-mono uppercase tracking-wider">
                                Browse thousands of manga series by popularity and genres.
                            </p>
                        </div>
