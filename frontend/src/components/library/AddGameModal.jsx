...
function AddGameModal({ onClose, onAdd, preselectedGame = null, existingEntry = null, games = [] }) {
    ...
    const [formData, setFormData] = useState({
        ...
        title: existingEntry?.title || preselectedGame?.title || '',

        genre: existingEntry?.genre || preselectedGame?.genres?.[0] || '',
        ...
        platforms: existingEntry?.platforms || preselectedGame?.platforms?.map(p => {
        ...
        cover: existingEntry?.cover || preselectedGame?.cover || '',
    ...
    const [gameSelected, setGameSelected] = useState(!!(preselectedGame || existingEntry))
            ...
            <div className="bg-[#111118] border border-[#2a2a35] rounded-lg
                ...
                <div className="flex items-center justify-between p-5
                    ...
                    >
                        ...
                        {existingEntry ? 'Edit Game' : preselectedGame ? 'Log This Game' : 'Log a Game'}
                ...
                <div className="p-5 flex flex-col gap-4">
                    ...
                    {/* IGDB Search — hidden when opened from GameDetail or editing */}

                    {!preselectedGame && !existingEntry && (
                    ...
                    >
                        ...
                        {submitting ? 'Logging...' : existingEntry ? '💾 Save Changes' : '🎮 Log Game'}
