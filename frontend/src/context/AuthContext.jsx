...
const buildUser = (userData) => ({
    ...
    isLikesPublic: userData.isLikesPublic ?? true,
    isWishlistPublic: userData.isWishlistPublic ?? true,
    isAnimeLikesPublic: userData.isAnimeLikesPublic ?? true,
    isAnimeWishlistPublic: userData.isAnimeWishlistPublic ?? true,
    isMangaLikesPublic: userData.isMangaLikesPublic ?? true,
    isMangaWishlistPublic: userData.isMangaWishlistPublic ?? true,
    isMovieLikesPublic: userData.isMovieLikesPublic ?? true,
    isMovieWishlistPublic: userData.isMovieWishlistPublic ?? true,
    isTVLikesPublic: userData.isTVLikesPublic ?? true,
    isTVWishlistPublic: userData.isTVWishlistPublic ?? true,
    xp: userData.xp || 0,
