...
// Both users lose -1 XP when someone unfollows
...
router.post('/unfollow/:userId', protect, async (req, res) => {
    ...
    try {
        ...
        await Promise.all([
            ...
            deductXP(req.user._id, 1),          // person who unfollowed loses XP

            deductXP(req.params.userId, 1)       // person who got unfollowed loses XP
