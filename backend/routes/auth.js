...
router.get('/followers/:userId', async (req, res) => {
    ...
    try {
        ...
        const user = await User.findById(req.params.userId).populate('followers', 'username avatar bio isPrivate followers badge level')
...
router.get('/following/:userId', async (req, res) => {
    ...
    try {
        ...
        const user = await User.findById(req.params.userId).populate('following', 'username avatar bio isPrivate followers badge level')
